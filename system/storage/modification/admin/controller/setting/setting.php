...
//    $statements = preg_replace("/\s/", ' ', $statements);
        ...
        if (isset($this->request->post['config_vie_custom_js'])) {
          $data['config_vie_custom_js'] = $this->request->post['config_vie_custom_js'];
        } else {
          $data['config_vie_custom_js'] = html_entity_decode($this->config->get('config_vie_custom_js'), ENT_QUOTES, 'UTF-8');
        }
