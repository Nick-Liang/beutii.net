...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <li><a href="#tab-custom-js" data-toggle="tab"><?php echo 'Custom JavaScript'; ?></a></li>
      ...
      <li><a href="#tab-custom-css" data-toggle="tab"><?php echo 'Custom CSS'; ?></a></li>
        ...
        <div class="tab-pane" id="tab-custom-js">
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-name"><span data-toggle="tooltip" title="Note that JavaScript must be wrapped by script tag."><?php echo 'Custom JavaScript'; ?></span></label>
            <div class="col-sm-10">
              <textarea name="config_vie_custom_js" class="form-control" style="height: 300px;" placeholder="<script>alert('hello');</script>"><?php echo $config_vie_custom_js; ?></textarea>
            </div>
          </div>
        </div>
